...
**Path in repo:** `fic-downloader/` (root of plugin); `fic-downloader/manifest.json`, `fic-downloader/vite.config.ts`
...
**Depends on modules:** none
**Path in repo:** `fic-downloader/src/types/`
...
**Path in repo:** `fic-downloader/src/settings/`
...
**Path in repo:** `fic-downloader/src/request-queue/`
...
**Path in repo:** `fic-downloader/src/parsers/`
...
**Path in repo:** `fic-downloader/src/renderers/`
...
**Path in repo:** `fic-downloader/src/orchestrator/`
...
**Path in repo:** `fic-downloader/src/popup/`
...
**Path in repo:** `fic-downloader/src/notifications/`
